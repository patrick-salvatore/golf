...
export function AppProvider(props: { children: JSX.Element }) {
  const [rounds] = createResource(RoundStore.fetchFromServer);
  const [clubs] = createResource(ClubStore.fetchFromServer);
...
interface AppContextValue {
  ...
  rounds:Resource<LocalRound[]>
  clubs: Resource<LocalClub[]>;
