    ...
    <div class="max-w-lg mx-auto pb-20 pt-8 px-4">
      ...
      <div class="grid grid-cols-2 gap-4 mb-12">
        <Show
          ...
          fallback={
            ...
            >
              ...
              <div class="relative bg-slate-900 rounded-[22px] p-5 flex items-center justify-between border border-white/10 group-hover:bg-slate-800 transition-colors h-full">
                <div class="text-left">
          ...
          >
            ...
            <div class="relative bg-slate-900 rounded-[22px] p-5 flex items-center justify-between border border-white/10 group-hover:bg-slate-800 transition-colors h-full">
              <div class="text-left flex-1">
                ...
                <span class="block text-xl font-bold text-white truncate max-w-[200px]">
        ...
        >
          ...
          <div class="relative bg-slate-900 rounded-[22px] p-5 flex items-center justify-between border border-white/10 group-hover:bg-slate-800 transition-colors h-full">
            <div class="text-left">
              <div class="flex space-x-1 items-center justify-center mb-2">
                <div class="h-8 w-8 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 group-hover:bg-blue-500 group-hover:text-white transition-all">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4"
                    fill="none"
                ...
                <span class="text-lg font-bold text-white">Analytics</span>
              </div>
        ...
        >
          ...
          <div class="relative bg-slate-900 rounded-[22px] p-5 flex items-center justify-between border border-white/10 group-hover:bg-slate-800 transition-colors h-full">
            <div class="text-left">
              <div class="flex space-x-1 items-center justify-center mb-2">
                <div class="h-8 w-8 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-400 group-hover:bg-purple-500 group-hover:text-white transition-all">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4"
                    fill="none"
                ...
                <span class="text-lg font-bold text-white">Builder</span>
              </div>
